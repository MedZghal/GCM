                                                          ...
                                                          <div class="tab-content">
                                                            ...
                                                            <!-- Begin Acte body -->
                                                             <div class="row" style="margin-left: 20px">
                                                                    ...
                                                                    <img class="pull-left" style="margin-left: 20px;" src="../img/bloc.png" alt="Details">
                                                                    <div class="col-md-6">
                                                                         <div class="form-group form-md-line-input has-success ">
                                                                            <div class="input-icon">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="form-group form-md-line-input has-success ">
                                                                        <div class="input-icon">
                                                                            <input id="Cotation" name="Cotation" type="number" class="form-control" placeholder="Cotation">
