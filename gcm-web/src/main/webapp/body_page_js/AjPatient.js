...
/*commande*/
          $("#hidecnam").click( function (){
            ...
            $("#code_apci").inputmask('99-99-99-99', {
                    numericInput: true,
                                        ...
                                        buttons : '[No][Yes]'
                                            ...
                                            if (ButtonPressed === "Yes") {
                                                ...
                                                if(Err.toString() ==="true"){
                                                    window.parent.swal("Notification !", "Assurance CNAM Supprimer Avec Succès ", "success");
                                        ...
                                        buttons : '[No][Yes]'
                                            ...
                                            if (ButtonPressed === "Yes") {
                                                ...
                                                if(Err.toString() ==="true"){
                                                    ...
                                                    $("#date_valid_apci").val('');
                                                    $("#code_apci").val('');
                                                    window.parent.swal("Notification !", "Traitements APCI Supprimer Avec Succès ", "success");
                            ...
                            var codeapci =RemoveCaractere($("#code_apci").val());
                                ...
                                { 
                                   ...
                                   if($("#collapse_2").hasClass('in')){
                                           ...
                                           Err = AjAssuranceCNAM($("#regime_affi").val(),$("#qualite").val(),$("#ident_unique").val(),$("#rang_Assur").val(),$("#date_valid_cnam").val(),$("#type_cnam").val());
                                       }
                                       else
                                           Err="true";
                                    ...
                                    if(Err.toString()=== "true")
                                           {
                                               ...
                                               if(Err.toString()=== "true")
                                               {
                                                   window.parent.swal("Notification !", "Patient insérer Avec Succès ", "success");
                                    ...
                                    if($("#collapse_2").hasClass('in')){   
                                        if(!$('#SuppCnam').hasClass('hide'))
                                           Err = UpdateAssuranceCNAM(CptAssurCnam,$("#regime_affi").val(),$("#qualite").val(),$("#ident_unique").val(),$("#rang_Assur").val(),$("#date_valid_cnam").val(),$("#type_cnam").val());
                                       else{
                                           CptAssurCnam = GetCptParamByCode("CptAssurCnam");   
                                           Err = AjAssuranceCNAM($("#regime_affi").val(),$("#qualite").val(),$("#ident_unique").val(),$("#rang_Assur").val(),$("#date_valid_cnam").val(),$("#type_cnam").val());
                                       }
                                       ...
                                       if(Err.toString()=== "true"){
                                          Err =UpdatePatient(numFichPatient,$("#nom").val(),$("#prenom").val(),$("#sexse").val(),$("#datnaiss").val(),$("#sutfam").val(),$("#prof").val(),$("#adr").val(),$("#fixe").val(),$("#gsm").val(),$("#poid").val(),CodeVille,$('#fich').val(),$("#autreAssur").val(),codeapci,$("#type_apci").val(),$("#date_valid_apci").val(),CptAssurCnam);
                                            ...
                                            if(Err.toString()=== "true")
                                                   {
                                                       window.parent.swal("Notification !", "Patient Modifier Avec Succès ", "success");
                                                       window.location.href="AjPatient.jsp";
                                                   }
                                                     else
                                                      window.parent.swal("Notification !!!", "Erreur lors de l'insertion du APCI", "error");
       ...
       /*     $(".bootstrap-switch").on('switchChange.bootstrapSwitch', function () {
                 var state =$("#unlock").bootstrapSwitch('state');
                 console.log(state);
                                    ...
                                    window.parent.$.SmartMessageBox({
                                        ...
                                        buttons : '[No][Yes]'
                                            ...
                                            if (ButtonPressed === "Yes") {
                                                    ...
                                                    window.parent.swal("Notification !", "Element supprimer Avec Succès ", "success");
            ...
            if(localStorage.getItem('Update')==="true")
            {
                            ...
                            $('#datnaiss').val(DateMM_DD_YYYY(datenaiss));
                            ...
                            if(patient.codeApci !== ""){
                                ...
                                $('#date_valid_apci').val(DateMM_DD_YYYY(D_valid_apci));
