...
function AjPatientByMedecin(code_Med_Trit,num_patient)
{
    var reponse;
    $.ajax({
        url: "../Gestion_Patient?type=update&function=AjPatientByMedecin&code_Med_Trit="+code_Med_Trit+"&num_patient="+num_patient,
        type: 'POST',
        async: false,
        dataType: "json",
        error: function (jqXHR, textStatus, errorThrown)
...
function AjAssuranceCNAM(regime_affi,qualite,ident_unique,rang_Assur,date_valid,type_cnam)
{
    var reponse;
    $.ajax({
        url: "../Gestion_Patient?type=update&function=AjAssuranceCNAM&regime_affi="+regime_affi+"&qualite="+qualite+"&ident_unique="+ident_unique+"&rang_Assur="+rang_Assur+"&date_valid="+date_valid+"&type_cnam="+type_cnam,
        type: 'POST',
        async: false,
        dataType: "json",
        error: function (jqXHR, textStatus, errorThrown)
...
function UpdateAssuranceCNAM(num_Assur,regime_affi,qualite,ident_unique,rang_Assur,date_valid,type_cnam)
{
    var reponse;
    $.ajax({
        url: "../Gestion_Patient?type=update&function=UpdateAssuranceCNAM&num_Assur="+num_Assur+"&regime_affi="+regime_affi+"&qualite="+qualite+"&ident_unique="+ident_unique+"&rang_Assur="+rang_Assur+"&date_valid="+date_valid+"&type_cnam="+type_cnam,
        type: 'POST',
        async: false,
        dataType: "json",
        error: function (jqXHR, textStatus, errorThrown)
