 ...
 function RemplirActesNonRemb(Actes, element){
   ...
   $.each(Actes, function (i){
       if(Actes[i] !== null){
            ...
            tree_html+='<div class="pull-right" style="margin-left: -10px;margin-top: 4px;"> <a class="btn btn-circle btn-icon-only btn-default" href="javascript:DeleteActeMedicaux('+Actes[i].acte.numActe.toString()+','+Actes[i].consultation.numConsult.toString()+');"><i class="icon-trash"></i></a></div>';
