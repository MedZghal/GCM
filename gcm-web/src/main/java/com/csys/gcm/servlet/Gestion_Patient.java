                    ...
                    case "AjPatientByMedecin":
                        {
                            ...
                            out.println(gson.toJson(WS.PortCltWS.ajPatientByMedecin(code_Med_Trit, num_patient)));
                            break;
                        }
                    case "SuppPatient":
                        {
                    ...
                    case "UpdateAssuranceCNAM":
                        {
                            ...
                            out.println(gson.toJson(WS.PortCltWS.updateAssuranceCNAM(num_Assur,regime_affi,qualite,ident_unique,rang_Assur,dateC1,type_cnam)));
                            break;
                        }
                    case "AjAssuranceCNAM":
                        {
                            ...
                            XMLGregorianCalendar dateC1 = DatatypeFactory.newInstance().newXMLGregorianCalendar(c1);
                            String type_cnam=request.getParameter("type_cnam");
                            out.println(gson.toJson(WS.PortCltWS.ajAssuranceCNAM(regime_affi,qualite,ident_unique,rang_Assur,dateC1,type_cnam)));
                            break;
                        }
