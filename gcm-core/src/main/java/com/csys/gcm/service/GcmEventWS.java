...
public class GcmEventWS {
    ...
    public String AjPatientByMedecin(@WebParam(name = "code_Med_Trit") int code_Med_Trit ,@WebParam(name = "num_patient") int num_patient) {
        try {
            return new PatientDao().AjPatientByMedecin(code_Med_Trit, num_patient);
    ...
    public List<CabinetMedical> GetParametre()  {
        return new CabinetMedicalDao().GetParemetre();
    }
    ...
    public String AjAssuranceCNAM(@WebParam(name = "regime_affi") String regime_affi,@WebParam(name = "qualite") String qualite,@WebParam(name = "idn_uniq") String ident_unique,@WebParam(name = "Rang") int rang_Assur,@WebParam(name = "date_valid") Date date_valid,@WebParam(name = "type") String type) {
        try {
            return new AssuranceDao().AjAssuranceCNAM(regime_affi, qualite, ident_unique, rang_Assur, date_valid, type);
    ...
    public String UpdateAssuranceCNAM(@WebParam(name = "num") int numAssur,@WebParam(name = "regime_affi") String regime_affi,@WebParam(name = "qualite") String qualite,@WebParam(name = "idn_uniq") String ident_unique,@WebParam(name = "Rang") int rang_Assur,@WebParam(name = "date_valid") Date date_valid,@WebParam(name = "type") String type) {
         return new AssuranceDao().UpdateAssuranceCNAM(numAssur, regime_affi, qualite, ident_unique, rang_Assur, date_valid, type);
    }
    ...
    public String AjRecette(@WebParam(name = "Montant") String montant,@WebParam(name = "date_trans") Date date_trans,@WebParam(name = "libelle") String libelle,@WebParam(name = "type") String type,@WebParam(name = "num_consult") int num_consult) {
        return new RecetteDao().AjRecette(montant, date_trans, libelle, type, num_consult);
    }
    ...
    public String AjMotif(@WebParam(name = "Lib") String Lib) {
        return new MotifDao().AjMotif(Lib);
    }
