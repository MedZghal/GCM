...
public class BilanBioRenal implements Serializable {
    ...
    public BilanBioRenal(Integer numBilan, String creatinemie, String uree, String poids, String clairanceCreatinine) {
        this.numBilan = numBilan;
    ...
    public String toString() {
        return "com.csys.gcm.model.BilanBioRenal[ numBilan=" + numBilan + " ]";
    }
