...
@NamedQueries({
    ...
    @NamedQuery(name = "CabinetMedical.findByCode_Med_Trit", query = "SELECT c FROM CabinetMedical c WHERE c.codeMedTrit = :codeMedTrit"),
...
public class CabinetMedical implements Serializable {
    ...
    public String toString() {
        return "com.csys.gcm.model.CabinetMedical[ numCab=" + numCab + " ]";
    }
