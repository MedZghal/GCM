...
public class AssuranceCNAM implements Serializable {
    ...
    public AssuranceCNAM(Integer numAssur, String regimeAffi, String qualite, String identUnique, int rangAssur, String type) {
        this.numAssur = numAssur;
    ...
    public String toString() {
        return "com.csys.gcm.model.AssuranceCNAM[ numAssur=" + numAssur + " ]";
    }
