...
@NamedQueries({
    ...
    @NamedQuery(name = "SalleAttente.findByNumMedecin", query = "SELECT s FROM SalleAttente s WHERE s.numMedcTrait = :numMedcTrait"),
    @NamedQuery(name = "SalleAttente.findByNumligneAttend", query = "SELECT s FROM SalleAttente s WHERE s.numligneAttend = :numligneAttend"),
...
public class SalleAttente implements Serializable {
    ...
    public String toString() {
        return "com.csys.gcm.model.SalleAttente[ numligneAttend=" + numligneAttend + " ]";
    }
